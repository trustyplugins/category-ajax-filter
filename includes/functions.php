...
class CAF_POST_ACTIONS
{
    ...
    public function __construct()
    {
        ...
        add_action('caf_after_article_container_start', array($this, 'caf_manage_layout_start'), 5);
    ...
    public function caf_after_article_container_start($id)
    {
        ...
        if (class_exists("TC_CAF_PRO")) {
            $data = array();
            echo apply_filters("caf_after_article_container_start", $output, $data, $post);
        } else {
            echo $output;
        }
    }
