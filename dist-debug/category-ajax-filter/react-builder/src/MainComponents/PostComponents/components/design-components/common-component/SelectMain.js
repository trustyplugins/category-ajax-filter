...
const SelectMain = (props) => {
  ...
  const { property, label, options, defaultValue, styleState = 'default' ,styleTab='' ,deviceSwitch} = props;
  ...
  if (type === "module") {
    ...
    if (ModuleStyle[device][styleState]?.[property]) {
      currentposition = ModuleStyle[device][styleState][property];
    } 
    else {
      if (device === "desktop") {
        if (styleState === "hover") {
          if (ModuleStyle[device]["default"]?.[property]) {
            currentposition = ModuleStyle[device]["default"][property];
          }
        }
      }
      if (device === "tablet") {
        if (styleState === "default") {
          if (ModuleStyle["desktop"]["default"]?.[property]) {
            currentposition = ModuleStyle["desktop"]["default"][property];
          }
        } else {
          if (ModuleStyle[device]["default"]?.[property]) {
            currentposition = ModuleStyle[device]["default"][property];
            ...
            if (ModuleStyle["desktop"]["hover"]?.[property]) {
              currentposition = ModuleStyle["desktop"]["hover"][property];
            } else {
              if (ModuleStyle["desktop"]["default"]?.[property]) {
                currentposition =
