...
import {
  buildExportMeta,
  detectAvailableImportScopes,
  pickScopedExportCommonData,
} from "./importExportScopes";
            ...
            >
              <div className="caf-import-template-thumb">
                ...
                {item.tier && (
                  <span
                    className={[
                      "caf-import-template-badge",
                      `caf-import-template-badge--${item.tier}`,
                      item.tier === "free" ? "caf-import-template-badge-free" : "",
                    ]
                      .filter(Boolean)
                      .join(" ")}
                  >
                ...
                <div className="caf-import-template-actions">
                  <button
                    type="button"
                    className="preview"
                    onClick={() => dispatch(setPreviewTemplate(item.id))}
                  >
