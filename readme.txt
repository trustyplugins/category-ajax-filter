...
Supporting all WordPress post types and custom taxonomies, CAF enables you to build and deploy filters with zero technical knowledge. Design unlimited post layouts with the visual builder. Enhance filtering with AI-powered search, advanced analytics, SEO controls, custom field filtering, and responsive float buttons for mobile.

Now featuring the visual CAF Builder, the next generation of filter creation giving you complete control with flexible layout positioning, independent module customization, and instant device-responsive design. Build once, deploy everywhere with responsive filters that work perfectly on desktop, tablet, and mobile.
...
Yes. The full 3-step visual builder is free to use. Some individual modules and settings (listed under Category AJAX Filter Pro above) require a Pro license. The builder itself is not gated.
...
Every change is saved to the Revisions panel with a timestamp. Restore any previous version with one click. Free keeps your last 2 revisions, Pro keeps your last 10.
