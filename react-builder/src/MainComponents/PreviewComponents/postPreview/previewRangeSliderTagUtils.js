 ...
 */
export const resolveListItemTermLabel = (listItem) => {
  if (!listItem) {
    return "";
  }
  ...
  const attrLabel = String(
    listItem.getAttribute("data-caf-term-label")
      || listItem.getAttribute("data-caf-tooltip")
      || listItem.getAttribute("title")
      || ""
  ).trim();
  if (attrLabel) {
    return attrLabel;
