...
import elementorIcon from "./images/elementor_icon.svg";
import diviIcon from "./images/divi_icon.svg";
import wooIcon from "./images/woo_icon.svg";
import allThemeIcon from "./images/all_theme_icon.svg";
...
const EXISTING_LAYOUT_INTEGRATIONS = [
  { id: "elementor", label: "Elementor", tone: "elementor", icon: elementorIcon },
  { id: "divi", label: "Divi", tone: "divi", icon: diviIcon },
  { id: "woocommerce", label: "WooCommerce", tone: "woo", icon: wooIcon },
  { id: "themes", label: "All themes", tone: "themes", icon: allThemeIcon },
];
              ...
              <>
                      ...
                      >
                        ...
                        >
                          <img
                            ...
                            width={24}
                            height={24}
                            className="caf-existing-layout-integration-icon-img"
                          />
                        </span>
                ...
                >
                  ...
                  >
                    ...
                    <span
                      className="caf-existing-layout-troubleshoot-chevron anticon anticon-down"
                      aria-hidden="true"
                    />
                  </button>
                  {showResultsSelector && (
