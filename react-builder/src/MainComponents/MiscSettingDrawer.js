        ...
        <div className="caf-main-setting-page-popup-content">
          <div className="caf-main-setting-page-popup-form-section">
            ...
            >
              {renderToggleField(
                "Dynamic term counts",
                "Term counts always use the live catalog (not a saved snapshot). Enable this to also recalculate counts as visitors select filters, and to disable terms with no matching results.",
