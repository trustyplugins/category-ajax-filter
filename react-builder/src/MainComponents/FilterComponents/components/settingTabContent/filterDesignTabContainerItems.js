...
import { Col, Row, Segmented, Switch, Tooltip } from "antd";
...
export function buildFilterDesignTabContainerItems(ctx) {
  const {
    type,
    module,
    props,
        ...
        <>
          {type === 'module' && (
            <div className="caf-builder-setting-row-label meta-dropdown-dyn">
              {module.key !== 'reset' && module.key !== 'customtext' &&(
              <FilterDesignTabInnerTabs
                ...
                items={
                  ...
                  module.key !== 'dropdown_filter' && module.key !== 'search'  &&
                  {
                    key: "meta",
      ...
      children: (
        <>
          {/* {module.key !== 'dropdown_filter' && ( */}
            <>
            {type === 'module' && module.key !== 'reset' && module.key !== 'customtext' && settings?.label?.is_label === "true" && (
              <div className="caf-builder-setting-row-label meta-dropdown-dyn">
                <FilterDesignTabInnerTabs
                 // activeKey={'header'}
            ...
            {type === 'module' && (module.key === 'reset' || module.key === 'customtext') && settings?.icons?.visibility  &&(
              <div className="caf-builder-setting-row-label meta-dropdown-dyn">
                <FilterDesignTabInnerTabs
                 isCollapseOpen={isCollapsePanelOpen("1")}
                 activeKey={selectedMetaContainer}
