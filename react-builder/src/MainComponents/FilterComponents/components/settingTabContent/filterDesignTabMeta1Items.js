...
import {
  shouldShowFilterDesignIconStyleTab,
...
export function buildFilterDesignTabMeta1Items(ctx) {
  ...
  const showDesignIconTabUnderText = isWooRatingModule
    ? showDesignIconTab
    : shouldShowFilterDesignIconStyleTabUnderText(settings, module?.key);
              ...
              items={
                styleTab === "selectmeta" ?
                  [
                    ...
                    settings?.show_icon === 'true' && showDesignIconTabUnderText
                      ? {
                        key: "selecticon",
