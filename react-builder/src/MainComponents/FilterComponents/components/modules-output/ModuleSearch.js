  ...
  return (
    <>
      ...
      {settings.label.is_label === "true" && (
        ...
        {closeToggle === "false" && (
          <>
            <div className="caf-filter-module-search-wrapper"> 
      ...
      <style>
        ...
        .caf-row-${rowindex} .caf-column-${columnindex} .caf-module-${moduleindex} .caf-filter-module-search-wrapper{
          ${generateFilterCSS("meta", "default", selectedDevice, styleDefault)}
        }
        .caf-row-${rowindex} .caf-column-${columnindex} .caf-module-${moduleindex} .caf-filter-module-search-wrapper:hover{
